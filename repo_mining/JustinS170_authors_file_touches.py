...
#find default branch of repo   
url = f'https://api.github.com/repos/' + repo 
response = requests.get(url)    
repo_data = response.json()
default = repo_data.get("default_branch")
print("default branch is " + default)
...
fileOutput = 'data/authors_touches_' + file + '.csv'
...
for filename, info in dictfiles.items():
    for author, date in zip(info['authors'], info['dates']):
        writer.writerow([filename, info['count'], author, date])
fileCSV.close()
